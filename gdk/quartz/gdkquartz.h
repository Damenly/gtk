...
typedef enum
{
  GDK_OSX_MAJOR_MIN = 10,
  GDK_OSX_MAJOR_TIGER = 10,
  GDK_OSX_MAJOR_LEOPARD = 10,
  GDK_OSX_MAJOR_SNOW_LEOPARD = 10,
  GDK_OSX_MAJOR_LION = 10,
  GDK_OSX_MAJOR_MOUNTAIN_LION = 10,
  GDK_OSX_MAJOR_MAVERICKS = 10,
  GDK_OSX_MAJOR_YOSEMITE = 10,
  GDK_OSX_MAJOR_EL_CAPITAN = 10,
  GDK_OSX_MAJOR_SIERRA = 10,
  GDK_OSX_MAJOR_HIGH_SIERRA = 10,
  GDK_OSX_MAJOR_MOJAVE = 10,
  GDK_OSX_MAJOR_CATALINA = 10,
  GDK_OSX_MAJOR_BIGSUR = 11,
  GDK_OSX_MAJOR_MONTEREY = 12,
  GDK_OSX_MAJOR_MAX = 12,
} GdkOSXMajorVersion;
